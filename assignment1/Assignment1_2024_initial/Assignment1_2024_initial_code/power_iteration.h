#ifndef ASSIGNMENT1_2024_POWER_ITERATION_H
#define ASSIGNMENT1_2024_POWER_ITERATION_H
...
namespace eigenvalue {
    ...
    //class to implement the power iteration
    class power_iteration
    {
    public:
        power_iteration(const std::size_t& m_it = 1000, const double& tol = 1e-6, const checkT& term = BOTH): max_it(m_it), tolerance(tol), termination(term) {};
